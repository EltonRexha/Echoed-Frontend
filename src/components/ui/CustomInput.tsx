...
const CustomInput = ({
  ...
  return (
    <>
      <input
        {...inputProps}
        className={`block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent font-sans border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-shade-200 focus:outline-none focus:ring-0 focus:purple-shade-300 peer ${

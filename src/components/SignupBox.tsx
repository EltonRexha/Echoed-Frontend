...
function SignupOptions({
  ...
  setSignup: React.Dispatch<React.SetStateAction<SignUpOptions | undefined>>;
}) {
  return (
    <div className="flex flex-col space-y-4 w-full max-w-sm mx-auto">
      ...
      <Button
        ...
        className="w-full cursor-pointer"
        onClick={() => {
          setSignup(SignUpOptions.google);
        }}
      >
        <svg
      ...
      <Button
        ...
        className="w-full cursor-pointer"
        onClick={() => {
          setSignup(SignUpOptions.github);
        }}
      >

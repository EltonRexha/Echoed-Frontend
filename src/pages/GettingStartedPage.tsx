...
function GettingStartedPage(): JSX.Element {
  ...
  return (
      <div className="overflow-x-hidden font-raleway">
                    ...
                    >
                      <div className="text-light-secondary dark:text-dark-secondary bg-[color:rgba(255,255,255,0.2)] dark:bg-[color:rgba(255,255,255,0.1)] rounded shadow-2xl p-4 backdrop-blur-2xl">
                        ...
                        <p className="mb-10">
                          ...
                          click the "Post" button after composing your message.
                          To make your posts more engaging, you can easily
                          upload images or videos alongside your text.
                        </p>
                        <ul className="flex flex-col gap-2 mb-10">
                          ...
                          <li>
                            ...
                            by clicking the image icon to select a file from
                            your device.
                          </li>
                          <li>
                      ...
                      <div className="text-light-secondary dark:text-dark-secondary bg-[color:rgba(255,255,255,0.2)] dark:bg-[color:rgba(255,255,255,0.1)] rounded shadow-2xl p-4 backdrop-blur-2xl">
                        ...
                        <div className="mb-3">
                          ...
                          <ul className="flex flex-col gap-2">
                            ...
                            <li>
                              ...
                              Click on a hashtag to explore posts related to
                              that topic.
                            </li>
                            <li>
                              <span className="font-bold">
                        ...
                        <div className="mb-3">
                          ...
                          <p>
                            ...
                            your location, interests, and engagement. You can
                            also explore global trends to see what’s happening
                            worldwide.
                          </p>

                          <p>
                            Engage with trending topics to stay in the loop and
        ...
        >
          <motion.div
            className="bg-layer min-h-[100vh] w-[100vw] flex flex-col justify-center"
              ...
              >
                ...
                <div className="mb-3">
                  ...
                  <p>
                    ...
                    send messages privately or in group chats. Conversations are
                    easy to keep track of, and you’ll never miss an important
                    message.
                  </p>
                </div>
